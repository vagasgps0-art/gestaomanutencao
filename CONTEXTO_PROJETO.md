...
- Isolamento de chaves de ambiente do Supabase implementado. CÛdigo fonte higienizado e .env adicionado ao .gitignore para seguranÁa.

- Deploy autom·tico via gh-pages configurado para o GitHub Pages. Link p˙blico gerado: https://vagasgps0-art.github.io/paienelgestao

- CÛdigo reconfigurado para suportar deploy via Vercel (limpeza das amarras do GitHub Pages).
